...
// TMHF if tmhf is "yes"
	...
	else if (location === "charlotte_south" && tmhfOption === "yes") {
        sentence += "\n\n*Taylor Morrison Home Funding, Inc. NMLS #8588, 495 North Keller Road, Suite 550, Maitland, FL 32751. Licensed locations: NC: #L-191654 | SC: #MLS-8588. Buyer is not required to finance through Affiliated Lender to purchase a home; however, buyer must elect to utilize the services of Affiliated Lender and the services of Closing Agent  suggested by Seller only to receive certain promoted incentives as outlined in Buyer’s specific Purchase Agreement, which may differ by time, home selected, community and jurisdiction or contain other qualifying criteria. All loans are subject to underwriting and loan qualification of the lender. Services not available in all states. Rates, terms and conditions offered are subject to change without notice. Additional license information available at NMLS Consumer Access: www.nmlsconsumeraccess.org. ";
    }
...
// Entity Info"	
  ...
  if (location === "s-california") {
    sentence += "\n\n";
    sentence += "This is not an offering in any state where prohibited or otherwise restricted by law. No Purchase Agreement may be negotiated or signed by a prospective buyer for the purchase of a home until the Community's applicable Conditional or Final Public Report has been issued by the Department of Real Estate (DRE). Please see a Taylor Morrison Community Sales Manager for details and visit www.taylormorrison.com for additional state and community specific disclaimers, licensing information and other details (as applicable). "+copyrightYear +"Taylor Morrison Services, Inc., DRE #00968795; Taylor Morrison Services, Inc., CSLB License #519465, and William Lyon Homes, Inc., CSLB #527293. Taylor Morrison of California, LLC and William Lyon Homes, Inc. All rights reserved.";
  } else if (location === "sacramento") {
    sentence += "\n\n";
    sentence += "This is not an offering in any state where prohibited or otherwise restricted by law. Please see a Taylor Morrison Community Sales Manager for details and visit www.taylormorrison.com for additional state and community specific disclaimers, licensing information and other details (as applicable). "+copyrightYear +"Taylor Morrison Services, Inc., DRE  00698795; Taylor Morrison Services, Inc., CSLB License #519465. Taylor Morrison of California, LLC. All rights reserved.";
  } else if (location === "bay") {
    sentence += "\n\n";
    sentence += "This is not an offering in any state where prohibited or otherwise restricted by law. Please see a Taylor Morrison Community Sales Manager for details and visit www.taylormorrison.com for additional state and community specific disclaimers, licensing information and other details (as applicable). "+ copyrightYear +"Taylor Morrison Services, Inc., DRE  00698795; Taylor Morrison Services, Inc., CSLB License #519465. Taylor Morrison of California, LLC. All rights reserved.";
  } else if (location === "jacksonville") {
    sentence += "\n\n";
    sentence += "This is not an offering in any state where prohibited or otherwise restricted by law. Please see a Taylor Morrison Community Sales Manager for details and visit www.taylormorrison.com for additional state and community specific disclaimers, licensing information and other details (as applicable). Taylor Morrison Realty of Georgia, Inc. Firm #75069. "+ copyrightYear + ", Taylor Morrison of Georgia, LLC,  Taylor Morrison of Florida, Inc. CBC1265083.";
    ...
    sentence += "\n\n";
    sentence += "This is not an offering in any state where prohibited or otherwise restricted by law. Please see a Taylor Morrison Community Sales Manager for details and visit www.taylormorrison.com for additional state and community specific disclaimers, licensing information and other details (as applicable). "+ copyrightYear + "Taylor Morrison of Florida, Inc. CBC1257462. All rights reserved.";
    ...
    sentence += "\n\n";
    sentence += "This is not an offering in any state where prohibited or otherwise restricted by law. Please see a Taylor Morrison Community Sales Manager for details and visit www.taylormorrison.com for additional state and community specific disclaimers, licensing information and other details (as applicable). "+ copyrightYear + "Taylor Morrison of Florida, Inc. CRC1328617 & CGC1537334, Taylor Woodrow Communities at Artisan Lakes, L.L.C.  CGC1519714. All rights reserved.";
  } else if (location === "treasure") {
    sentence += "\n\n";
    sentence += " For our Age Qualified Communities only: At least one resident of household must be 55 or older, and additional restrictions apply. Some residents may be younger than 55 in limited circumstances. For minimum age requirements for permanent residents in a specific community, complete details available. This is not an offering in any state where prohibited or otherwise restricted by law. Please see a Taylor Morrison Community Sales Manager for details and visit www.taylormorrison.com for additional state or community specific disclaimers, licensing information and other details (as applicable). © ${copyrightDate}, Taylor Morrison of Florida, Inc. CBC1259457, CGC1529148. All rights reserved.";
    ...
    sentence += "\n\n";
    sentence += "This is not an offering in any state where prohibited or otherwise restricted by law. No offer to sell or lease may be made or accepted prior to the issuance of the final AZ Subdivision Disclosure Report. A public report is available at the State Real Estate Department’s website at www.azre.gov.  Please see a Community Sales Manager for details or visit www.taylormorrison.com for additional state and community specific disclaimers, licensing information and other details (as applicable)." + copyrightYear + "Taylor Morrison/Arizona, Inc., ROC # 179178B; JCH Construction, LLC, ROC # 256789; William Lyon Homes, Inc., ROC # 080777. TM Homes of Arizona, Inc., AZ DRE # CO535669000; AV Homes of Arizona, LLC, AZ DRE # LC632206000; William Lyon Southwest, Inc., AZ DRE # CO521011000. All rights reserved.";
    ...
    sentence += "\n\n";
    sentence += "This is not an offering in any state where prohibited or otherwise restricted by law. Please see a Taylor Morrison Community Sales Manager for details and visit www.taylormorrison.com for additional state and community specific disclaimers, licensing information and other details (as applicable). "+ copyrightYear + "Taylor Morrison of Carolinas, Inc.,  License No. 125194. All rights reserved. ";  
