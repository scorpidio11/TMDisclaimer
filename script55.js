...
// Entity Info"	
  ...
  if (location === "tradition") {
    ...
    sentence += "\n\n";
    sentence += "This is not an offering in any state where prohibited or otherwise restricted by law. Please see a Taylor Morrison Community Sales Manager for details and visit www.taylormorrison.com for additional state and community specific disclaimers, licensing information and other details (as applicable)." + copyrightYear + "Taylor Morrison of Florida, Inc., CRC1328617 (" +'"'+"Sponsor"+'"' + "). The Esplanade® name and logo owned by Esplanade Resort Experiences, LLC are federally registered and used with its express permission." ;
  } else if (location === "solivita") {
    sentence += "\n\n";
    sentence += "This is not an offering in any state where prohibited or otherwise restricted by law. Please see a Taylor Morrison Community Sales Manager for details and visit www.taylormorrison.com for additional state and community specific disclaimers, licensing information and other details (as applicable)." + copyrightYear + "Avatar Properties Inc. CBC #1254089. The Solivita® name and logo are federally registered." ;
    ...
    sentence += "\n\n";
    sentence += "This is not an offering in any state where prohibited or otherwise restricted by law. Please see a Taylor Morrison Community Sales Manager for details and visit www.taylormorrison.com for additional state and community specific disclaimers, licensing information and other details (as applicable)." + copyrightYear + "Robert Evon, Sales Manager #BS.0029612.SMGR; William Lyon Homes, Inc. dba Taylor Morrison, NSCL #0040722. All rights reserved.";
