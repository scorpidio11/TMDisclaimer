...
// Entity Info"	
  ...
  if (location === "tradition") {
    sentence += "\n\n";
    sentence += copyrightYear + "Taylor Morrison of Florida, Inc. CGC1529148, CBC1257822 & CBC1259457. The Esplanade® name and logo owned by Esplanade Resort Experiences, LLC are federally registered and used with its express permission. All rights reserved.";
  } else if (location === "wiregrass") {
    sentence += "\n\n";
    sentence += copyrightYear + "Taylor Morrison of Florida, Inc., CRC1328617 (" +'"'+"Sponsor"+'"' + "). The Esplanade® name and logo owned by Esplanade Resort Experiences, LLC are federally registered and used with its express permission." ;
  } else if (location === "solivita") {
    sentence += "\n\n";
    sentence += copyrightYear + "Avatar Properties Inc. CBC #1254089. The Solivita® name and logo are federally registered." ;
  } else if (location === "meridian") {
    sentence += "\n\n";
    sentence += copyrightYear + "William Lyon Homes, Inc., ROC # 080777. © January 2024, William Lyon Southwest, Inc., AZ DRE # CO521011000. ";
    ...
    sentence += "\n\n";
    sentence += copyrightYear + "Taylor Morrison Services, Inc., DRE #00968975; CSLB License #519465, Taylor Morrison of California, LLC. The Esplanade® name and logo are federally registered. All rights reserved.";
  } else if (location === "turkeycreek") {
    sentence += "\n\n";
    sentence += copyrightYear + "Taylor Morrison Services, Inc., DRE # 00968975., Taylor Morrison of California, LLC. The Esplanade® name and logo owned by Esplanade Resort Experiences, LLC are federally registered and used with its express permission.";
  } else if (location === "madeiraranch") {
    sentence += "\n\n";
    sentence += copyrightYear + "Taylor Morrison Services, Inc., DRE # 00968975. Taylor Morrison of California, LLC. The Esplanade® name and logo owned by Esplanade Resort Experiences, LLC are federally registered and used with its express permission.";
  } else if (location === "northgate") {
    sentence += "\n\n";
    sentence += copyrightYear + "Taylor Morrison of Carolinas, Inc. NCGCL #76596. The Esplanade® name and logo owned by Esplanade Resort Experiences, LLC are federally registered and used with its express permission. ";
  } else if (location === "oaktree") {
    sentence += "\n\n";
    sentence += copyrightYear + "Taylor Morrison Northwest, LLC #TAYLOMN791L8. Broker license: Cascadian King Company LLC #8193.";
    ...
    sentence += "\n\n";
    sentence += copyrightYear + "JCH Construction, LLC, ROC# 256789. © October 2023, AV Homes of Arizona, LLC, AZ DRE# LC632206000. All rights reserved.";
  }
